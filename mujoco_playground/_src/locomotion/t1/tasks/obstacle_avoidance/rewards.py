...
class ObstacleAvoidanceRewards:
    """Collection of reward / cost terms for the T1 ObstacleAvoidance task.
    ...
    def _cost_base_height(self, data: mjx.Data, info: dict[str, Any]) -> jax.Array:
        ...
        return jp.square(
            base_height - self.config.base_height_target
        )
    ...
    def _cost_feet_height(
        ...
        del info  # Unused.
        error = swing_peak / self.config.max_foot_height - 1.0
